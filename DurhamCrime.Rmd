...
plot = plot + 
  labs(title='Number of Gunshot Wounds in Durham, Jan. 2013 - Aug. 2017', x="Year", y="Month") +
  theme(
...
comp = comp + 
  labs(title='Total Gunshot Wounds in Durham by Type, Jan. 2013 - Aug. 2017', x="Year", y="Number of Gunshot Wounds") + 
